...
public class AndrooidActionBarCallbackMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {
  ...
  private static final String PROVIDES_TYPE_STRING = AndrooidActionBarCallbackMetadata.class
      .getName();
  ...
  private MethodMetadata getOnCreateAndrooidActionModeMethod() {
    ...
    MethodMetadataBuilder methodBuilder =
        new MethodMetadataBuilder(getId(), Modifier.PUBLIC, new JavaSymbolName(
            "onCreateAndrooidActionMode"), JavaType.BOOLEAN_PRIMITIVE, parameterTypes,
  ...
  private MethodMetadata getOnPrepareAndrooidActionModeMethod() {
    ...
    MethodMetadataBuilder methodBuilder =
        new MethodMetadataBuilder(getId(), Modifier.PUBLIC, new JavaSymbolName(
            "onPrepareAndrooidActionMode"), JavaType.BOOLEAN_PRIMITIVE, parameterTypes,
            parameterNames, bodyBuilder);
  ...
  private MethodMetadata getOnAndrooidActionItemClickedMethod() {
    ...
    MethodMetadataBuilder methodBuilder =
        new MethodMetadataBuilder(getId(), Modifier.PUBLIC, new JavaSymbolName(
            "onAndrooidActionItemClicked"), JavaType.BOOLEAN_PRIMITIVE, parameterTypes,
            parameterNames, bodyBuilder);
  ...
  private MethodMetadata getOnAndrooidDestroyActionModeMethod() {
    ...
    MethodMetadataBuilder methodBuilder =
        new MethodMetadataBuilder(getId(), Modifier.PUBLIC, new JavaSymbolName(
            "onAndrooidDestroyActionMode"), JavaType.VOID_PRIMITIVE, parameterTypes,
            parameterNames, null);
