...
public class AndrooidEntityMetadataProvider extends AbstractItdMetadataProvider {
	...
	protected final static Logger LOGGER = HandlerUtils.getLogger(AndrooidEntityMetadataProvider.class);
	...
	protected ItdTypeDetailsProvidingMetadataItem getMetadata(final String metadataIdentificationString,
		...
		AnnotationMetadata androoidEntityAnnotation = entityClass.getAnnotation(new JavaType(AndrooidEntity.class));

		JavaSymbolName identifierFieldValue = null;
		JavaType identifierTypeValue = null;

		AnnotationAttributeValue<String> identifierField = androoidEntityAnnotation.getAttribute("identifierField");
		AnnotationAttributeValue<Class<? extends Serializable>> identifierType = androoidEntityAnnotation
				.getAttribute("identifierType");
		...
		return new AndrooidEntityMetadata(metadataIdentificationString, aspectName, governorPhysicalTypeMetadata,
				physicalTypeIdentifier, entityMemberDetails, identifierFieldValue, identifierTypeValue);
	}
