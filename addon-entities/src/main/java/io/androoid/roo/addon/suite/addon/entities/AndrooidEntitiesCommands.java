...
public class AndrooidEntitiesCommands implements CommandMarker {
  ...
  public void createEntity(
      @CliOption(key = "class", optionContext = UPDATE_PROJECT, mandatory = true,
          help = "Name of the entity to create. (Ex: ~.domain.MyEntity)") final JavaType entity,
      @CliOption(key = "identifierField", mandatory = false, optionContext = UPDATE_PROJECT,
          help = "The identifier field name to use for this entity. If null, set 'id' as default.") final JavaSymbolName identifierField,
      @CliOption(
          key = "identifierType",
          mandatory = false,
          optionContext = "java-lang,project",
          help = "The data type that will be used for the identifier field (defaults to java.lang.Long)") final JavaType identifierType) {
