...
public class AndrooidDatabaseConfigMetadataProvider extends AbstractItdMetadataProvider {
  ...
  protected final static Logger LOGGER = HandlerUtils
      .getLogger(AndrooidDatabaseConfigMetadataProvider.class);

  public static final JavaType ANDROOID_DATABASE_CONFIG =
      new JavaType(AndrooidDatabaseConfig.class);
  ...
  protected String getGovernorPhysicalTypeIdentifier(final String metadataIdentificationString) {
    final JavaType javaType =
        AndrooidDatabaseConfigMetadata.getJavaType(metadataIdentificationString);
    final LogicalPath path = AndrooidDatabaseConfigMetadata.getPath(metadataIdentificationString);
