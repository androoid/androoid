 ...
 * @since 1.0
 */
public class AndrooidDatabaseConfigMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {

  private static final String PROVIDES_TYPE_STRING = AndrooidDatabaseConfigMetadata.class.getName();
   ...
   */
  public AndrooidDatabaseConfigMetadata(final String identifier, final JavaType aspectName,
  ...
  private MethodMetadataBuilder getMainMethod() {
    ...
    bodyBuilder.appendFormalLine("writeConfigFile(\"ormlite_config.txt\");");

    MethodMetadataBuilder methodBuilder =
        new MethodMetadataBuilder(getId(), Modifier.PUBLIC + Modifier.STATIC, methodName,
