...
public class AndrooidDatabaseHelperMetadata extends AbstractItdTypeDetailsProvidingMetadataItem {
  ...
  public AndrooidDatabaseHelperMetadata(final String identifier, final JavaType aspectName,
    ...
    // Adding constants
    FieldMetadataBuilder databaseName =
    ...
    FieldMetadataBuilder databaseVersion =
        new FieldMetadataBuilder(getId(), Modifier.PUBLIC + Modifier.STATIC + Modifier.FINAL,
            new JavaSymbolName("DATABASE_VERSION"), JavaType.INT_PRIMITIVE, "1");
  ...
  private MethodMetadataBuilder getEntityDaoGetter(JavaType entity) {
    ...
    JavaType returnType =
        new JavaType("com.j256.ormlite.dao.Dao", 0, DataType.TYPE, null, parameters);

    String daoName = entity.getSimpleTypeName().concat("Dao");
    String fieldDaoName =
        Character.toLowerCase(entity.getSimpleTypeName().charAt(0))
    ...
    MethodMetadataBuilder methodBuilder =
        new MethodMetadataBuilder(getId(), Modifier.PUBLIC, new JavaSymbolName(
            "get".concat(daoName)), returnType, parameterTypes, parameterNames, bodyBuilder);
   ...
   * @param bodyBuilder
   */
  private void buildEntityDaoGetterMethodBody(InvocableMemberBodyBuilder bodyBuilder,
      String daoName, JavaType entity) {
    ...
    bodyBuilder.appendFormalLine(String.format("%s = getDao(%s.class);", daoName,
  ...
  private MethodMetadataBuilder getEntityRuntimeExceptionDaoGetter(JavaType entity) {
    ...
    parameters.add(JavaType.INT_OBJECT);
    JavaType returnType =
        new JavaType("com.j256.ormlite.dao.RuntimeExceptionDao", 0, DataType.TYPE, null, parameters);
   ...
   * @param bodyBuilder
   */
  private void buildEntityRuntimeExceptionDaoGetterMethodBody(
      InvocableMemberBodyBuilder bodyBuilder, String daoName, JavaType entity) {
    ...
    bodyBuilder.appendFormalLine(String.format("%s = getRuntimeExceptionDao(%s.class);", daoName,
        entity.getSimpleTypeName()));
    bodyBuilder.indentRemove();
  ...
  private FieldMetadataBuilder getEntityDao(JavaType entity) {
    ...
    JavaSymbolName daoName =
        new JavaSymbolName(Character.toLowerCase(entity.getSimpleTypeName().charAt(0))
            + entity.getSimpleTypeName().substring(1).concat("Dao"));

    FieldMetadataBuilder entityDao =
        new FieldMetadataBuilder(getId(), Modifier.PRIVATE, daoName, new JavaType(
            "com.j256.ormlite.dao.Dao", 0, DataType.TYPE, null, parameters), null);
  ...
  private FieldMetadataBuilder getEntityRuntimeExceptionDao(JavaType entity) {
    ...
    JavaSymbolName daoName =
        new JavaSymbolName("runtimeException".concat(entity.getSimpleTypeName()).concat("Dao"));

    FieldMetadataBuilder entityDao =
        new FieldMetadataBuilder(getId(), Modifier.PRIVATE, daoName, new JavaType(
            "com.j256.ormlite.dao.RuntimeExceptionDao", 0, DataType.TYPE, null, parameters), null);
  ...
  private MethodMetadataBuilder getCloseMethod() {
    ...
    // Use the MethodMetadataBuilder for easy creation of MethodMetadata
    MethodMetadataBuilder methodBuilder =
        new MethodMetadataBuilder(getId(), Modifier.PUBLIC, new JavaSymbolName("close"),
  ...
  private MethodMetadataBuilder getOnCreateMethod() {
    ...
    List<AnnotatedJavaType> parameterTypes = new ArrayList<AnnotatedJavaType>();
    parameterTypes
        .add(new AnnotatedJavaType(new JavaType("android.database.sqlite.SQLiteDatabase")));
  ...
  private MethodMetadataBuilder getOnUpgradeMethod() {
    ...
    // Use the MethodMetadataBuilder for easy creation of MethodMetadata
    MethodMetadataBuilder methodBuilder =
        new MethodMetadataBuilder(getId(), Modifier.PUBLIC, new JavaSymbolName("onUpgrade"),
            JavaType.VOID_PRIMITIVE, parameterTypes, parameterNames, bodyBuilder);
    methodBuilder.setAnnotations(annotations);
  ...
  private void buildOnCreateMethodBody(InvocableMemberBodyBuilder bodyBuilder) {
    ...
    if (!this.entitiesToInclude.isEmpty()) {
      ...
      for (JavaType entity : this.entitiesToInclude) {
        ...
        bodyBuilder.appendFormalLine(String.format("%s.createTable(connectionSource, %s.class);",
            new JavaType("com.j256.ormlite.table.TableUtils").getNameIncludingTypeParameters(false,
                builder.getImportRegistrationResolver()), entity.getSimpleTypeName()));
      }
      ...
      bodyBuilder.appendFormalLine(String.format(
          "} catch (%s e) {",
          new JavaType("java.sql.SQLException").getNameIncludingTypeParameters(false,
  ...
  private void buildOnUpgradeMethodBody(InvocableMemberBodyBuilder bodyBuilder) {
    ...
    if (!this.entitiesToInclude.isEmpty()) {
      ...
      for (JavaType entity : this.entitiesToInclude) {
        ...
        // TableUtils.createTable(connectionSource, EntityX.class);
        bodyBuilder.appendFormalLine(String.format(
            "%s.dropTable(connectionSource, %s.class, true);", new JavaType(
                "com.j256.ormlite.table.TableUtils").getNameIncludingTypeParameters(false,
                builder.getImportRegistrationResolver()), entity.getSimpleTypeName()));
      }
  ...
  private void buildCloseMethodBody(InvocableMemberBodyBuilder bodyBuilder) {
    ...
    if (!this.entitiesToInclude.isEmpty()) {
      ...
      for (JavaType entity : this.entitiesToInclude) {
        ...
        JavaSymbolName runtimeExceptionDaoName =
            new JavaSymbolName("runtimeException".concat(entity.getSimpleTypeName()).concat("Dao"));
